...
const Hero = () => {
  ...
  return (
    <section ref={heroRef} id="hero" className="relative min-h-screen flex flex-col items-center justify-center pt-24 overflow-hidden">
      ...
      <div className="section-container relative z-10 w-full lg:scale-[1.1] origin-center transition-transform duration-300">
        ...
        >
          {/* Status Badge */}
          <motion.div
            className="hero-badge inline-flex items-center gap-2.5 px-5 py-2.5 rounded-full glass-card neon-border mb-5"
          ...
          {/* Title */}
          <motion.h1
            className="hero-title text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black font-display leading-[1.1] mb-4 tracking-tight"
            variants={itemVariants}
          ...
          >
            <span className="text-base sm:text-lg md:text-2xl text-muted font-bold inline-block">
              ICT Undergraduate
            </span>
            <br />
            <span className="text-xs sm:text-sm md:text-lg text-muted/70 font-medium inline-block mt-1">
          ...
          <motion.div
            className="mb-5 h-8 sm:h-10 flex items-center justify-center"
            variants={itemVariants}
            style={{ y: ySubtitle, opacity: opacitySubtitle }}
          >
            <AnimatePresence mode="wait">
              <motion.span
                key={roleIndex}
                className="text-base sm:text-lg md:text-2xl font-semibold gradient-text inline-block"
          ...
          {/* Description */}
          <motion.p
            className="hero-description text-xs md:text-base text-muted max-w-3xl mx-auto mb-7 leading-relaxed px-4 sm:px-0"
            variants={itemVariants}
          ...
          >
            ...
            <motion.a
              ...
              className="group flex items-center justify-center gap-2 sm:gap-2.5 w-full sm:w-auto px-5 py-2.5 sm:px-6 sm:py-3 rounded-xl font-semibold text-text text-xs sm:text-sm
          ...
          {/* Social Links */}
          <motion.div
            className="hero-socials flex gap-4 sm:gap-6 justify-center mt-6 sm:mt-8"
            variants={itemVariants}
            style={{ y: yButtons, opacity: opacityButtons }}
          >
            <a href="https://www.linkedin.com/in/tasuntha-chathunika/" target="_blank" rel="noopener noreferrer"
              className="flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 rounded-full glass-card neon-border text-text/70 
